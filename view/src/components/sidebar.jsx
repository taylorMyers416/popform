        ...
        return (
            <Sider
                ...
                >
                    ...
                    <Menu.Item key="3">
                    <Link style={{ fontSize: "16px" }} to ="/new-form"><Icon style={{ fontSize: "20px" }} type="file-add" />New Form</Link></Menu.Item>
                    <Menu.Item key="7">
                    ...
                    <SubMenu key="9" title={<span><Icon type="folder" />Your Forms</span>}>
                        <Menu.Item key="8"><Link style={{ fontSize: "16px" }} to = {{pathname: "/", state: {type: "all"}}}><Icon style={{ fontSize: "20px" }} type="form" />All forms</Link></Menu.Item>
                        <Menu.Item key="2"><Link style={{ fontSize: "16px" }} to = {{pathname: "/forms/inqueries",state: {type: "inquiry"}}}><Badge style={{ marginRight: "40px" }} count={5}><Icon style={{ fontSize: "20px" }} type="mail" /></Badge>Inqueries</Link></Menu.Item>
                        <Menu.Item key="4"><Link style={{ fontSize: "16px" }} to = {{pathname: "/forms/fillable-forms",state: {type: "fillable"}}}><Icon style={{ fontSize: "20px" }} type="profile" />Fillable Forms</Link></Menu.Item>
